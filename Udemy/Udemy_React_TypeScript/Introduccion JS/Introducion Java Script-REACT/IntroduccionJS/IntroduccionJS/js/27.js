...
const consultarAPI = async () => {
    try{
        ...
        console.log(`El resutado es PRIMERA: ${fin - inicio}`)
    } catch(error){
...
//El Promise.All Realiza consultas Paralelas entonces va  ucho mas rapido en la ejecucion
const consultarAPI2 = async () => {
    try{
        ...
        console.log(`El resutado es SEGUNDA: ${fin - inicio}`)
    } catch(error){
        console.log(error.message)
    }
}
